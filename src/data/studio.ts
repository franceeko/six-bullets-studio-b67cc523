...
export type Dev = {
  ...
  color: DevColor;
  avatar?: string;
  /** true when the avatar file is a video instead of an image */
  video?: boolean;
};
...
export const devs: Dev[] = [
  ...
  { name: "Marpuf",  role: "Community Manager",                              tag: "Management", color: "teal",   avatar: marpuf.url, video: true },
  { name: "Syntax",  role: "Lead Dev · Programmer",                          tag: "Dev",        color: "sage",   avatar: syntax.url },
